...
yay -S networkmanager-iwd grimshot clipman nerd-fonts ttf-fira-code slack-desktop \ 
	postman-bin signal-desktop spotify ncpamixer-git bluetuith swaylock-effects --noconfirm 
